function [H] = sphere(a,r,theta,f,threshold)
%SPHERE This is an implementation of the algorithm described in Duda &
%Marten's paper "Range dependence of the response of a spherical head
%model" [3].
